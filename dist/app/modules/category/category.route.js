...
router.post(
    ...
    (0, validation_middleware_1.validate)(
        category_validation_1.CategoryValidations.createCategorySchema
    ),
...
router.get(
    "/:categoryId",
    category_controller_1.CategoryControllers.getSingleCategory
);
router.put(
    "/:categoryId",
    (0, auth_middleware_1.default)(user_constant_1.USER_ROLE.admin),
...
router.delete(
    "/:categoryId",
    (0, auth_middleware_1.default)(user_constant_1.USER_ROLE.admin),
    category_controller_1.CategoryControllers.deleteCategory
);
