    ...
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { accessToken, refreshToken, user } =
                yield user_service_1.UserServices.register(req.body);
...
const login = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { accessToken, refreshToken, user } =
                yield user_service_1.UserServices.login(email, password);
    ...
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { accessToken, user } =
                yield user_service_1.UserServices.refreshToken(refreshToken);
            res.status(http_status_codes_1.StatusCodes.OK).json({
...
const updateAnUser = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const updatedUser = yield user_service_1.UserServices.updateAnUser(
                userId,
                {
                    username,
                    name,
