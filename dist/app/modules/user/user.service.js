...
const register = (userData) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        const accessToken = (0, jwt_util_1.createToken)(
            jwtPayload,
            env_1.default.jwt_access_secret,
            env_1.default.jwt_access_expires_in
        );
        const refreshToken = (0, jwt_util_1.createToken)(
            jwtPayload,
            env_1.default.jwt_refresh_secret,
            env_1.default.jwt_refresh_expires_in
        );
...
const refreshToken = (token) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { userId } = (0, jwt_util_1.verifyToken)(
                token,
                env_1.default.jwt_refresh_secret
            );
            if (!userId) {
...
const updateAnUser = (userId, userData) =>
    __awaiter(void 0, void 0, void 0, function* () {
